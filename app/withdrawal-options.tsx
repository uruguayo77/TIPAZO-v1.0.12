...
export default function WithdrawalOptionsScreen() {
  ...
  const handleWithdraw = async () => {
    if (!selectedOption) {
      showAlert('Error', 'Por favor selecciona un método de retiro');
      return;
    }
    ...
    if (withdrawalAmount > userBalance) {
      showAlert('Error', 'La cantidad excede tu saldo disponible');
      return;
    }
    ...
    try {
      ...
      showAlert('Error', 'No se pudo procesar tu solicitud. Por favor intenta de nuevo.');
    }
  };
        ...
        >
          ...
          <View style={styles.footer}>
            <Button
              ...
              isLoading={isLoading}
              rightIcon={<WithdrawalIcon size={isSmallDevice ? 18 : 20} color={colors.textDark} />}
            />
