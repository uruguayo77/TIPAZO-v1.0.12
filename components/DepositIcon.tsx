...
export const DepositIcon: React.FC<DepositIconProps> = ({ size = 24, color = '#fff' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <G clipPath="url(#clip0_4418_169454)">
      ...
      <Path d="M22 11.0303V16.1103C22 19.6203 21.11 20.5003 17.56 20.5003H6.44C2.89 20.5003 2 19.6203 2 16.1103V15.0103" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <Path d="M16.5 6L18 7.5L22 3.5" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </G>
    <Defs>
      <ClipPath id="clip0_4418_169454">
