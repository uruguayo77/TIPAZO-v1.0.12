...
export const SubscriptionBanner: React.FC<SubscriptionBannerProps> = ({ 
  ...
  // Update balance whenever component mounts or user changes
  React.useEffect(() => {
    if (user) {
        ...
        {status === 'trial' ? (
          <>
            ...
            <Text style={styles.description}>
              Disfruta de todas las funciones gratis. Después ${SUBSCRIPTION_PRICE.toFixed(2)} al mes.
            </Text>
          </>
          ...
          <>
            ...
            <Text style={styles.description}>
              Tu suscripción ha finalizado. Suscríbete para seguir recibiendo propinas.
            </Text>
          </>
        ) : (
          <>
            ...
            <Text style={styles.description}>
              Tu prueba gratuita ha finalizado. Suscríbete para seguir recibiendo propinas.
            </Text>
          </>
        )}
      </View>
